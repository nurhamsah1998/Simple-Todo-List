    ...
    <div className="">
      <form onSubmit={submit} className="max-w-[470px] mx-auto mt-20 ">
        ...
        <div className="grid mt-5">
          ...
          <input value={value} onChange={ip} placeholder="Password" className="border-[1px] py-2 pl-4 pr-3 rounded-md border-gray-300 focus:border-indigo-600 " type="password" />
        </div>
